        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/cms" className="text-gray-400 hover:text-white transition-colors flex items-center">
              ...
              <li>
                <Link href="/cms/articles" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-5 mr-2">
                    <FaRegNewspaper />
                  </span>
                  Articles
              ...
              <li>
                <Link href="/cms/authors" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-5 mr-2">
                    <FaUserEdit />
                  </span>
                  Authors
              ...
              <li>
                <Link href="/cms/categories" className="text-gray-400 hover:text-white transition-colors flex items-center">
                  <span className="w-5 mr-2">
                    <FaTags />
                  </span>
                  Categories
